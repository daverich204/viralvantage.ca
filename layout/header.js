            ...
            <div className="container clearfix">
              ...
              <div className="extra-nav">
                <div className="extra-cell">
                  <Link href="/contact-us"><a className="btn btn-corner gradient btn-primary"><i
                    className="fa fa-angle-right m-r10"></i>Contact Us</a></Link>
                </div>
              </div>
              <div className={`header-nav navbar-collapse collapse justify-content-end ${show ? "show" : ""}`}
                ...
                <ul className="nav navbar-nav navbar">
                  ...
                  <li className={`${open === "about" ? "open" : ""}`}><a
                    onClick={() => setOpen("about")}><span>Pages</span><i className="fa fa-chevron-down"></i></a>
                  ...
                  <li className={`${open === "services" ? "open" : ""}`}><a
                    onClick={() => setOpen("services")}><span>Services</span><i className="fa fa-chevron-down"></i></a>
                    <ul className="sub-menu">
                      <li><Link href="/services"><a>Services We Offer</a></Link></li>
                      <li><Link href="/services-details-3"><a>Services Details</a></Link></li>
                    </ul>
                  </li>
                  {/*<li className={`${open === "blog" ? "open" : ""}`}><a*/}
                  {/*  onClick={() => setOpen("blog")}><span>Blog</span><i className="fa fa-chevron-down"></i></a>*/}
                  {/*  <ul className="sub-menu">*/}
