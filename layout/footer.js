...
function Footer() {
  return (
    <>
      {/* <!-- Footer --> */}
      <footer className="site-footer style-3" id="footer" style={{
        ...
        <div className="footer-top">
          <div className="container">
            <div className="row">
              <div className="col-xl-3 col-lg-12 col-md-4 col-sm-6 wow fadeIn" data-wow-duration="2s"
                   data-wow-delay="0.2s">
                <div className="widget widget_about">
                  <div className="footer-logo">
                    <Link href="/"><a><img src="images/logo-white.png" alt=""/></a></Link>
                  </div>
                  <p>Maecenas pellentesque placerat quam, in finibus nisl tincidunt sed. Aliquam magna augue, malesuada
              ...
              <div className="col-xl-2 col-lg-3 col-md-4  col-sm-6 wow fadeIn" data-wow-duration="2s"
                   data-wow-delay="0.4s">
              ...
              <div className="col-xl-3 col-lg-3 col-md-4  col-sm-6 wow fadeIn" data-wow-duration="2s"
                   data-wow-delay="1.0s">
                <div className="widget widget_getintuch">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <span>General Information <br/>info@viralvantage.ca</span>
                    </li>
                    <li>
                      <i className="fa fa-map-marker gradient"></i>
                      <span>Based in Winnipeg, MB, Canada</span>
                    </li>
                  </ul>
                </div>
              </div>
